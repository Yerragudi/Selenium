...
public class GL020_02 {
	...
	public void testCase2002() {
		...
		try {
			...
			final String SUBLEDGER_APPLICATION = cells.get(2);
			final String LEDGER = cells.get(3);
			final String FROM_DATE = cells.get(4);
			final String TO_DATE = cells.get(5);
			...
			Thread.sleep(9000);
			process.selectSubledgerApplication(SUBLEDGER_APPLICATION);
			Thread.sleep(3000);
