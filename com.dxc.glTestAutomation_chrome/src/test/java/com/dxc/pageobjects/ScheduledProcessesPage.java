...
//Constructor
	...
	@FindBy(xpath = "//table[@summary='List of Processes Meeting Search Criteria']//tr[1]//td[3]")
	...
	@FindBy(xpath="*//select[@id=(//label[text()='Subledger Application']/@for)]")
	private WebElement subledgerApplication;
	// -----
	// Methods
	...
	public void scheduleNewProcess(String processName) throws InterruptedException { // General Ledger Trial Balance Report
...
//		driver.switchTo().window(mainWindowHandle);
	...
	public void clickOnRepublishBtn() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//img[contains(@title,'Republish')]"))).click();
	}
	...
	public void selectSubledgerApplication(String option) {
		Select s = new Select(subledgerApplication);
		s.selectByVisibleText(option);
	}
