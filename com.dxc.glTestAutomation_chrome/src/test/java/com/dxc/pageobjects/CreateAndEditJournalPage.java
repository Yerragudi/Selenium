...
//				.visibilityOfElementLocated(By.xpath("*//input[@id=(//label[text()='Accounting Period']/@for)]")))
//				.clear();
//		wait.until(ExpectedConditions
//				.visibilityOfElementLocated(By.xpath("*//input[@id=(//label[text()='Accounting Period']/@for)]")))
//				.sendKeys(accountingPeriod);
...
//			System.out.println("Legal Entity Input, not available.");
	...
	public void enterAccountingDate(String date) {
		...
		this.accountingDate.sendKeys(date,Keys.RETURN);
	}
...
//		WebElement acctColumn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//th[contains(@id,'ap1:jeLineAppTable:_ATp:t3:c5')]")));
//
//		Actions action = new Actions(driver);
//		Thread.sleep(3000);
//		action.clickAndHold(acctColumn).moveByOffset(800,0).release(acctColumn).perform();
//		
//		accountElem.click();
