...
public class ErrorHandler {
	...
	private static void logger(int excelRowNumber, String status, String errCode, String msg) {
		ExcelFileHandler.logTestResult(excelRowNumber, 2, status);
		ExcelFileHandler.logTestResult(excelRowNumber, 3, ErrorHandler.getTimestamp());
		ExcelFileHandler.logTestResult(excelRowNumber, 4, errCode);
		ExcelFileHandler.logTestResult(excelRowNumber, 5, msg);
	}
}
